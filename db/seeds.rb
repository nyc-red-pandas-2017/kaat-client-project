...
Recipe.create(name: "Caprese Appetizer", ingredients: "20 grape tomatoes", directions: Faker::Lorem.sentence,
   difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 1,
   user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 1, user_id: 1)

Recipe.create(name: "King crab appetizers", ingredients: "2 packages refrigerated biscuit", directions: Faker::Lorem.sentence,
    difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 1,
    user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 2, user_id: 1)

Recipe.create(name: "Brie Cheese appetizer", ingredients: "1 wheel Brie cheese", directions: Faker::Lorem.sentence,
   difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 1,
   user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 3, user_id: 1)

Recipe.create(name: "Pepper Jelly appetizer", ingredients: "1 package cream cheese", directions: Faker::Lorem.sentence,
  difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 1,
  user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 4, user_id: 1)

# Category 2: Salads
Recipe.create(name: "Alyson Broccoli salad", ingredients: "Broccoli", directions: Faker::Lorem.sentence,
  difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 2,
  user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 5, user_id: 1)

Recipe.create(name: "Strawberry spinach salad", ingredients: "Spinach", directions: Faker::Lorem.sentence,
   difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 2,
   user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 6, user_id: 1)

Recipe.create(name: "Black bean and Corn salad", ingredients: "Beans, Corn", directions: Faker::Lorem.sentence,
  difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 2,
  user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 7, user_id: 1)

Recipe.create(name: "Beet salad with Goat Cheese", ingredients: "4 medium beets", directions: Faker::Lorem.sentence,
  difficulty: Faker::Number.between(1, 5), prep_time: Faker::Number.digit, category_id: 2,
  user_id: 1)
Rating.create(votes: Faker::Number.digit, recipe_id: 8, user_id: 1)
